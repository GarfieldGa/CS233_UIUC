...
HD_PWD='/home/hantaoz3/cs233git/FPGALab2/FPGALab2/FPGALab2.runs/clk_wiz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz.vds -m64 -mode batch -messageDb vivado.pb -notrace -source clk_wiz.tcl
