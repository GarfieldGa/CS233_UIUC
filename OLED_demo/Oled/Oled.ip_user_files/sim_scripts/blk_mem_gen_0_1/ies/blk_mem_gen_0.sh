...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../Oled.srcs/sources_1/ip/blk_mem_gen_0_1/sim/blk_mem_gen_0.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.blk_mem_gen_0 $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.blk_mem_gen_0 -input simulate.do
}
# Script usage
usage()
{
